...
Pembangun ukuran memungkinkan Anda membuat langkah-langkah di sekitar akun bisnis dan secara opsional menggunakan informasi hierarki. Informasi hierarki digunakan untuk menggulung perhitungan ukuran di seluruh akun dan semua sub akun terkaitnya. Misalnya, Anda dapat membuat langkah-langkah seperti total pendapatan untuk setiap kelompok akun bisnis yang diidentifikasi oleh hierarki mereka. Untuk informasi lebih lanjut, lihat [menentukan dan mengelola langkah](measures.md).
