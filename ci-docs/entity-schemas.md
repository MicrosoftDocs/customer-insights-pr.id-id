...
Lihat entitas di [Navigator Entitas Model Data Umum](https://microsoft.github.io/CDM/). Pilih entitas dari bagian Aplikasi Wawasan untuk mendapatkan daftar entitas Customer Insights dan definisinya.

:::image type="content" source="media/CDM-entity-navigator.png" alt-text="Navigator Entitas CDM menampilkan entitas CustomerActivity.":::
