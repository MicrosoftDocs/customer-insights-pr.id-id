...
Jika Anda memperkaya entitas di tingkat sumber data untuk membantu meningkatkan hasil penyatuan Anda, pilih entitas tersebut. Untuk informasi selengkapnya, lihat [Pengayaan untuk sumber](data-sources-enrichment.md) data. Jika Anda memilih entitas yang diperkaya di **halaman Rekaman** duplikat, Anda tidak perlu memilihnya lagi.
...
1. **Pada halaman Kondisi** yang cocok, gunakan panah pindahkan ke atas dan ke bawah untuk memindahkan entitas dalam urutan yang Anda inginkan, atau seret dan lepas. Misalnya, pilih **eCommerceCustomers** sebagai entitas utama dan **loyCustomers** sebagai entitas kedua.

1. Agar setiap rekaman dalam entitas sebagai pelanggan unik terlepas dari apakah kecocokan ditemukan, pilih **Sertakan semua rekaman**. Setiap rekaman dalam entitas ini yang tidak cocok dengan rekaman di entitas lain mana pun disertakan dalam profil terpadu. Catatan yang tidak memiliki kecocokan disebut singletons.
...
Dalam kebanyakan kasus, entitas yang cocok mengarah ke profil pelanggan unik dengan data terkonsolidasi. Untuk mengatasi kasus positif palsu dan negatif palsu yang jarang terjadi, tentukan pengecualian untuk aturan kecocokan. Pengecualian diterapkan setelah memproses aturan kecocokan dan menghindari pencocokan semua catatan, yang memenuhi kriteria pengecualian.
...
|Lewati            | Menentukan nilai yang harus selalu diabaikan sistem dalam fase kecocokan. |  Abaikan nilai *11111* dan *Tidak Diketahui* selama pertandingan.        |
